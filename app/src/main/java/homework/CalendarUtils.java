...
public class CalendarUtils {
    ...
    private static String CALENDARS_NAME = "e学友作业提醒";
    private static String CALENDARS_ACCOUNT_NAME = "e-study assistant";
    private static String CALENDARS_ACCOUNT_TYPE = "toolbox.homeworkNotification";
    private static String CALENDARS_DISPLAY_NAME = "e学友作业提醒";
